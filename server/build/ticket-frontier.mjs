...
import { listActivities } from "../persistence/build-repository.mjs";
import { treePath } from "../platform/workspace-manager.mjs";
...
export async function getTicketFrontier({ work, project, featureSlug = null }) {
  ...
  const source = await readDiscoveredLocalTickets(worktreePath, {
    featureSlug,
  });
