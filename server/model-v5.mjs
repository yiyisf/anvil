...
export function newWork({ projectId, title, mode = "build", legacyReqId = null }) {
  ...
  const timestamp = now();
  return { id: id("WORK"), projectId, legacyReqId, title: title?.trim() || "未命名工作", mode, status: "draft", currentActivityId: null, workspace: {}, createdAt: timestamp, updatedAt: timestamp };
}
